...
insert into produto (id, nome, preco, data_criacao, descricao) values (3, 'Camera Cannon TekPix', 7599.0, date_sub(sysdate(), interval 1 day), 'Camera quase identica a original');
...
insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (2, 3, 7590, 2);
